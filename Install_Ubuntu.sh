qemu-system-x86_64 -m 4096 -cpu qemu64 -cdrom ubuntu-22.04.4-live-server-amd64.iso -hda ubuntu-docker.img -boot d -nographic -smp cores=1 -machine type=pc,accel=tcg -net nic -net user -rtc base=utc
